...
public class XXHash {
    ...
    /**
     * XXHash output as String
     *
     * @param base original string
     * @return XXHashed string
     */
    public static String getXXHash(String base) {
        return String.format("%016X", XXHash.hash64(base.getBytes())).toLowerCase();
    }
